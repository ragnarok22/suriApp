...
export default function DonateScreen() {
  ...
  return (
    <SimpleLayout style={styles.container}>
      ...
      <SwitchSelector options={options} onPress={(value) => setSelectedCurrency(value)}>
        <View>
          <ThemedText type="subtitle">{selectedCurrency === 'SRD' ? t('donate.srd') : t('donate.usd')}</ThemedText>
          <ThemedText>{t('donate.bank_subtitle') + selectedCurrency + t('donate.donations')}</ThemedText>
        </View>

        <View style={{ marginTop: 16, gap: 8 }}>
          <View style={styles.rowInfo}>
            <ThemedText>{t('donate.account_holder')}</ThemedText>
            <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center', width: '100%', flexShrink: 1 }}>
              <ThemedText style={{ flexWrap: 'wrap', maxWidth: '80%', marginLeft: 'auto' }}>{bankInfo[selectedCurrency].beneficiary}</ThemedText>
              <Pressable onPress={() => copyToClipboard(bankInfo[selectedCurrency].beneficiary)}>
          ...
          <View style={styles.rowInfo}>
            ...
            <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center' }}>
              ...
              <Pressable onPress={() => copyToClipboard(bankInfo[selectedCurrency].swift)}>
                <CopyIcon lightColor="black" darkColor="white" size={20} />
              </Pressable>
            </View>
          </View>
          ...
          <View style={styles.rowInfo}>
            ...
            <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center' }}>
              ...
              <Pressable onPress={() => copyToClipboard(bankInfo[selectedCurrency].account)}>
                <CopyIcon lightColor="black" darkColor="white" size={20} />
              </Pressable>
            </View>
          </View>
          ...
          <View style={styles.rowInfo}>
            ...
            <View style={styles.rowItem}>
              ...
              <Pressable onPress={() => copyToClipboard(bankInfo[selectedCurrency].bank)}>
                <CopyIcon lightColor="black" darkColor="white" size={20} />
              </Pressable>
            </View>
          </View>
